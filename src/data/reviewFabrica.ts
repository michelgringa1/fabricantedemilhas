...
export const reviewFabrica: Article = {
  ...
  rating: {
    ...
    itemDesc:
      'Treinamento online de milhas aéreas criado por Rodrigo Góes, com 8 níveis de conteúdo, aulas ao vivo e comunidade de promoções.',
    itemUrl: 'https://lp.fabricademilha.com/',
  },
  blocks: [
    ...
    },
    {
      ...
      rows: [
        ...
        ['Prata', 'Conceitos essenciais de milhas e pontos'],
        ['Ouro', 'Estratégias de acúmulo'],
        ['Safira', 'Uso das milhas (emissões e viagens)'],
        ['Rubi', 'Venda de milhas'],
        ['Platina', 'Recuperar o investimento no curso'],
        ['Diamante', 'Classe executiva, salas VIP e status'],
        ['Private', 'Estratégias avançadas'],
      ],
    },
    {
      t: 'p',
    ...
    { t: 'h3', text: 'Vale a pena para quem…' },
    {
      t: 'ul',
      items: [
        'Quer um método estruturado em vez de juntar dicas soltas de internet;',
        'Tem gastos mensais concentráveis no cartão ou capital para operar com volume;',
        'Pretende acompanhar promoções com frequência e tratar milhas como projeto de médio prazo;',
        'Valoriza comunidade ativa e aulas ao vivo além do conteúdo gravado.',
      ],
    },
    { t: 'h3', text: 'NÃO vale a pena para quem…' },
    {
      t: 'ul',
      items: [
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'O curso dedica um nível inteiro (Platina) a isso e ancora a garantia estendida nessas estratégias. É plausível para quem opera com dedicação e capital, mas não é automático nem garantido: resultados variam conforme gasto mensal, campanhas do período e mercado de venda de milhas.',
    },
  ],
  related: [
    { slug: '/rodrigo-goes-e-confiavel/', anchor: 'Rodrigo Góes é confiável? Análise do produtor' },
    { slug: '/cursos-de-milhas/', anchor: 'Comparador: todos os cursos de milhas analisados' },
