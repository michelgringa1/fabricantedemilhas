...
export const rodrigoGoes: Article = {
  slug: '/rodrigo-goes-e-confiavel/',
  type: 'review',
  cluster: 'Cursos',
  kicker: 'Análise completa',
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'Depende do seu perfil: quem quer método completo e comunidade ativa tende a aproveitar; quem espera renda garantida ou não tem tempo para acompanhar promoções, não. Nossa análise completa, com preço, garantia, prós e contras, dá a resposta detalhada.',
    },
  ],
  related: [
...
export const cursosComparador: Article = {
  ...
  blocks: [
    { t: 'h2', id: 'bom-curso', text: 'O que um bom curso de milhas precisa ensinar' },
    {
      ...
      items: [
        ...
        '<strong>Atualização contínua</strong>: o mercado muda todo mês; curso parado no tempo é prejuízo.',
      ],
    },
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'Um bom curso encurta a curva de aprendizado e evita erros caros, mas não substitui dedicação nem capital. Funciona para quem aplica o método com constância; frustra quem espera renda automática. Nenhum curso sério garante resultado.',
    },
    {
  ...
  related: [
    { slug: '/fabrica-de-milhas-vale-a-pena/', anchor: 'Análise completa do Fábrica de Milhas' },
    { slug: '/rodrigo-goes-e-confiavel/', anchor: 'Rodrigo Góes é confiável?' },
    { slug: '/melhor-curso-de-milhas/', anchor: 'Melhor curso de milhas: o ranking' },
...
export const melhorCurso: Article = {
  slug: '/melhor-curso-de-milhas/',
  type: 'comparador',
  cluster: 'Cursos',
  kicker: 'Ranking',
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'Alguns servem como porta de entrada, mas avalie o que fica de fora: comunidade de promoções e atualização contínua são o que sustenta resultado no longo prazo. Curso barato sem suporte vivo costuma virar PDF esquecido. Compare pelo custo por benefício, não pelo preço absoluto.',
    },
  ],
  related: [
    { slug: '/cursos-de-milhas/', anchor: 'Comparador completo de cursos de milhas' },
    { slug: '/fabrica-de-milhas-vale-a-pena/', anchor: 'Análise completa do líder do ranking' },
...
export const rendaExtra: Article = {
  slug: '/milhas-aereas-como-renda-extra/',
  type: 'satelite',
  ...
  related: [
    { slug: '/como-ganhar-dinheiro-com-milhas/', anchor: 'Guia completo: como ganhar dinheiro com milhas' },
